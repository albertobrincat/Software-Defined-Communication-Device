...
# Title: Wifi Rx
# Generated: Sat Mar 10 12:44:14 2018
##################################################
...
class wifi_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.single_pole_iir_filter_xx_0 = filter.single_pole_iir_filter_cc(1, 1)
        ...
        self.ieee802_11_frame_equalizer_0 = ieee802_11.frame_equalizer(chan_est, freq, samp_rate, True, False)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/lab/Progetti_Gnuradio/Brincat/802.11/wifi.pcap', True)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.ieee802_11_decode_mac_0, 'out'), (self.blocks_socket_pdu_0, 'pdus'))
        ...
        self.connect((self.osmosdr_source_0, 0), (self.single_pole_iir_filter_xx_0, 0))
        self.connect((self.single_pole_iir_filter_xx_0, 0), (self.blocks_complex_to_mag_squared_0, 0))
        self.connect((self.single_pole_iir_filter_xx_0, 0), (self.blocks_delay_0_0, 0))
